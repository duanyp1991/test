...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
     ...
     * @return string
     */
    protected function _CustomRenderCategoryMenuItemHtml($category, $level = 0, $isLast = false, $isFirst = false,
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        if($category->getUrlKey() == 'our-range') {
            $url = '/search';
        }
        if($hasActiveChildren) {
            $html[] = '<a '.$linkClass.'>';
        ...
        foreach ($activeChildren as $child) {
            $htmlChildren .= $this->_CustomRenderCategoryMenuItemHtml(
                $child,
                ($level + 1),
    ...
    {
        return $this->_CustomRenderCategoryMenuItemHtml($category, $level, $last);
    }
    ...
    public function renderCategoriesMenuHtml($level = 0, $outermostItemClass = '', $childrenWrapClass = '')
    {
        ...
        foreach ($activeCategories as $category) {
            $html .= $this->_CustomRenderCategoryMenuItemHtml(
                $category,
                $level,
